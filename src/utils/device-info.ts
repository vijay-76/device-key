...
export class DeviceInfoService {
  ...
  // new
  // "f3f45a3b5a4605391a5ccf85cb3af4992e7e1d964e268632d5659286e8fbda5d"
  // 415c8c6812367c2af2ab0452d1695eed24dfeb232bd4943564e912e266b42d84
  ...
  private static collectBasicInfo(): string {
    ...
    // Use only truly device-specific and stable data
    ...
    return [
      screenRes, // screen size (usually consistent across browsers)
  ...
  static async generateFingerprint(): Promise<string> {
    ...
    const data = this.collectBasicInfo();
